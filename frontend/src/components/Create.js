...
import { TextField, Button, Typography, Box, Stack,Paper,ButtonGroup } from "@mui/material";
      ...
      <Box>
        ...
        Craft Tailored Insights
          ...
          >
              ...
              >
                  <Typography sx={{ fontWeight: "600", fontSize: "25px", mb: 1, justifyContent:'center',alignItems:"center"
                          }}>Select Sentiment</Typography>
                  <Typography sx={{ fontSize: "26px", fontWeight: "bold" }}>
                      {/* Button Group */}
                      <Paper elevation={3} sx={{ p: 1, bgcolor: "inherit",border:'0px' }}>
                          <ButtonGroup>
                            {options.map((option) => (
                              <Button
                                key={option.value}
                                ...
                                sx={{
                                  ...
                                  "&:hover": {
                                    bgcolor: selected === option.value ? "#ad1457" : "#f0f0f0",
                                  },
                                  borderRadius: "50px",
                                  px: 2,
                                  py: 1,
                      ...
                      {result ? (
                          <Box>
                              <Typography variant="body2" sx={{ fontStyle: "italic" }}>
                                  {showmore ? result.created_review : result.created_review?.substring(0, 100)}
                              </Typography>
